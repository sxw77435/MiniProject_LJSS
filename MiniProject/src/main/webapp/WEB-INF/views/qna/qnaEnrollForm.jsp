...
<body>
    ...
    <!-- 햄버거 메뉴 -->
        ...
        <div class="innerOuter">
            ...
            <form id="enrollForm" method="post" action="insertQna" enctype="multipart/form-data">
                <table align="center">
                    <tr>
                        <th><label for="title" >제목</label></th>
                        <td><input type="text" id="title" class="form-control" name="qnaTitle" style="width:100%" required ></td>
                    </tr>
                    <tr>
                        <th><label for="writer">작성자</label></th>
                        <td><input type="text" id="writer" class="form-control" value="${ loginUser.memId }" name="qnaWriter" style="width:100%;"></td>
                    </tr>
              
                    <tr>
                        <th colspan="1"><label for="content">내용</label></th>
                    
                        <th colspan="2"><textarea class="form-control" required name="qnaContent" id="content" rows="10" style="resize:none;" style="width:100%;"></textarea></th>
                    </tr>
                </table>
                <br>
